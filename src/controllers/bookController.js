...
//         {authorName:"sk"},
//         {$set: data},
//         ($new : true)//it will show us updated document
//     )
//     res.send({msg: allBooks})
// }
...
{
    let savedData1 = await authorModel.find({author_name: "Chetan Bhagat"})
    console.log(savedData1)
    // let finaldata = savedData1.author_id
    // console.log(finaldata)
    let savedData2 = await BookModel.findById({author_id:finaldata})
    res.send(savedData2)
}
